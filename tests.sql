...
VALUES ('Alice', 'Smith', 'mobin.fallahi.1384@gmail.com', '1234567890', 'pass123', 'New York'),
       ...
       ('Arya', 'Tehrani', 'Arya.j3@example.com', '1234567894', 'hashedpass4', 'Tehran'),
       ('Zahra', 'Aghaie', 'Zahra.j3@example.com', '1234567895', 'hashedpass5', 'Qazvin'),
       ('Mobin', 'Fallahi', 'mobinfallahi84@gmail.com', '09999984211', 'mobin2005', 'Mashhad'),
...
VALUES (18, '2024-01-10', 'Active');

INSERT INTO Admins (user_id, admin_role)
VALUES (7, 'Support Agent'),
       (8, 'Manager'),
       (9, 'Supervisor'),
       (10, 'Tech Admin'),
       (14, 'Manager'),
...
VALUES ('United States', 'California', 'Los Angeles'),
...
INSERT INTO Train (vehicle_id, star, car_number, is_reserved_fully, wifi_access, catering, ventilation, etc, flat_wagon)
VALUES (2, '4', 12, FALSE, TRUE, TRUE, TRUE, null, TRUE),
...
INSERT INTO Airplane (vehicle_id, airline, airplane_class, arrival_airport, departure_airport, catering, wifi_access,
                      flat_bed_seat, etc, flight_number)
VALUES (3, 'Delta Airlines', 'Business', 'JFK', 'LAX', TRUE, TRUE, TRUE, 'Boeing 777', 'DL123'),
...
INSERT INTO Bus (vehicle_id, bus_type, seats_row_per_row, ventilation, etc, catering, personal_monitor)
VALUES (1, 'Double Decker', 4, TRUE, 'Express', TRUE, TRUE),
...
INSERT INTO Ticket (departure_location_id, arrival_location_id, arrival_time, arrival_date, departure_time, departure_date,
                    remaining_capacity, cost, vehicle_id)
VALUES (1, 2, '13:00:00', '2025-06-10', '10:30:00', '2025-06-10', 45, 95.75, 2),
       (2, 1, '17:00:00', '2025-06-07', '14:15:00', '2025-06-07', 28, 110.00, 3),
       (2, 3, '17:00:00', '2025-05-16', '23:45:00', '2025-05-15', 120, 450.00, 4),
       (3, 2, '17:00:00', '2025-05-20', '08:30:00', '2025-05-20', 115, 420.50, 5),
       (4, 5, '17:00:00', '2025-05-11', '12:00:00', '2025-05-11', 60, 200.00, 6),
       (7, 8, '17:00:00', '2025-05-14', '16:45:00', '2025-05-14', 85, 320.75, 7),
       (9, 10, '17:00:00', '2025-06-01', '09:15:00', '2025-06-01', 40, 280.00, 8),
       (11, 12, '17:00:00', '2025-06-05', '20:30:00', '2025-06-05', 75, 350.50, 9),
       (13, 14, '17:00:00', '2025-06-10', '11:00:00', '2025-06-10', 200, 550.00, 10),
       (15, 1, '17:00:00', '2025-06-15', '07:45:00', '2025-06-15', 180, 480.25, 1),
       (1, 15, '17:00:00', '2025-06-15', '07:45:00', '2025-06-14', 200, 500, 11),
       (17, 15, '17:00:00', CURDATE(), '07:45:00', '2025-05-06', 200, 500, 11),
       (18, 15, '17:00:00', CURDATE(), '07:45:00', '2025-05-06', 200, 500, 11),
       (18, 1, '17:00:00', '2025-05-05', '07:45:00', '2025-05-05', 200, 1000, 11),
       (1, 15, '17:00:00', '2025-06-15', '07:45:00', '2025-06-14', 200, 200, 3);

INSERT INTO Reservation (ticket_id, passenger_id, reservation_status, reservation_date)
VALUES (1, 1, 'Confirmed', '2023-01-20'),
...
VALUES (42, 3, '2025-05-4', 'Completed', 1000, 'Credit Card'),
...
UPDATE Reservation
SET admin_id = 16
WHERE reservation_id = 17;
UPDATE Reservation
SET admin_id = 19
WHERE reservation_id = 26;
UPDATE Reservation
SET admin_id = 20
WHERE reservation_id = 35;
UPDATE Reservation
SET admin_id = 21
