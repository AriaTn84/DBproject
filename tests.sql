...
(1, 15, CURDATE(), '07:45:00', '2025-05-6', 200, 500, 11),
(17, 15, CURDATE(), '07:45:00', '2025-05-6', 200, 500, 11),
(18, 15, CURDATE(), '07:45:00', '2025-05-6', 200, 500, 11),
(18, 1, '2025-05-05', '07:45:00', '2025-05-4', 200, 1000, 11);

INSERT INTO Reservation (ticket_id, passenger_id, reservation_status) VALUES
(1, 1, 'Confirmed'),
(2, 2, 'Pending'),
(3, 3, 'Cancelled By Passenger'),
(4, 4, 'Confirmed'),
(5, 5, 'Pending'),
(6, 6, 'Confirmed'),
(7, 1, 'Confirmed'),
(8, 2, 'Cancelled By Passenger'),
(9, 3, 'Confirmed'),
(10, 3, 'Pending'),
(1, 1, 'Confirmed'),
(1, 1, 'Pending'),
(2, 1, 'Cancelled By Passenger'),
(2, 2, 'Confirmed'),
(3, 2, 'Pending'),
(3, 2, 'Confirmed'),
(4, 2, 'Confirmed'),
(4, 3, 'Cancelled By Passenger'),
(5, 3, 'Confirmed'),
(6, 3, 'Pending'),
(6, 5, 'Confirmed'),
(7, 5, 'Pending'),
(7, 6, 'Cancelled By Passenger'),
(8, 6, 'Confirmed'),
(8, 1, 'Pending'),
(9, 11, 'Confirmed'),
(9, 11, 'Confirmed'),
(10, 12, 'Cancelled By Passenger'),
(10, 15, 'Confirmed'),
(10, 2, 'Pending'),
(1, 2, 'Confirmed'),
(10, 4, 'Cancelled By Admin'),
(10, 18, 'Confirmed'),
(4, 18, 'Confirmed'),
(11, 18, 'Confirmed'),
(11, 4, 'Confirmed'),
...
(31, 2, 'Completed', 480.25, 'Credit Card'),
(32, 4, 'Failed', 55.00, 'Credit Card'),
(33, 18, 'Completed', 480.25, 'Credit Card'),
(34, 18, 'Completed', 420.50, 'Credit Card'),
